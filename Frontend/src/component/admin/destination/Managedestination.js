...
export default function Managedestination(){
  ...
  const deleteDestination=(id)=>{
      ...
      ApiServices.deleteDestination(data).then((res)=>{
          if(res.data.success){
                ...
                <tbody>
                  {data.map((el,index)=>(
                    <tr key={index}>
                      ...
                      <td>{el.address}</td>
                      <td>
                        <Link to={`/admin/editdestination/${el._id}`} className='btn btn-success'>
                          <i className='fa fa-edit'></i>
                        </Link>
                      </td>
                      <td>
                        <button onClick={()=>{deleteDestination(el._id)}} className='btn btn-danger'><i className='fa fa-trash'></i></button>
                      </td>
                    </tr>
                  ))}
                </tbody>
